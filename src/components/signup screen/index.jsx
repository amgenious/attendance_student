...
export const SignupScreenindex = () => {
    ...
    async function submit(e){
        ...
        try{
            await axios.post("https://attendance-backend-gsu3.onrender.com/studentsignup",{
        ...
        <div className='flex flex-col justify-evenly text-center  p-4'>
            ...
            <div>
                <form className='flex flex-col' method='POST'>
                    ...
                    <button onClick={submit} className='bg-black text-white px-12 py-4 border-2 hover:border-black hover:text-black hover:bg-white mb-5'>SIGN UP</button>
                </form>
            </div>
            <div>
